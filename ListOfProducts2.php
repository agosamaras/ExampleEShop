...
?>
<div id="content">
<H1>Modify product</H1><H2>View by category:</H2>
<form action="Sort_items_engine2.php" method="post">
...
{ //show the available items
	...
	while($items_info = mysql_fetch_array($get_items_res))
	{
		...
		echo "<th>"; echo "<a href='ItemModify.php?name=$item_name'>" . 'MODIFY'.'</a>'."</th>";
		echo "</tr>";
	}
	echo "</table>";		
